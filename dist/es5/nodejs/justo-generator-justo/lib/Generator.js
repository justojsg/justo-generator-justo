    ...
    answers) {
      ...
      if (answers.packagejson === undefined || answers.packagejson == "true" || answers.packagejson === true) {
        this.template("_package.json", "package.json", { 
          ...
          authorUrl: answers.authorUrl });}} }, { key: "help", get: function get() {return { desc: "Generate the files of a Justo.js project.", params: { desc: "Project description.", author: "Author name.", authorEmail: "Author email.", authorUrl: "Author URL.", packagejson: "Generate the package.json file: true or false. Default: true." }, commands: {} };} }]);return _class;}(_justoGenerator.HandlebarsGenerator);exports.default = _class;